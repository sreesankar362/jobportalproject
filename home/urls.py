...
from .views import HomeView, JobListingView, JobModelView,JobDetailView,AboutUsView, search,JobApplyView
...
urlpatterns = [
                  ...
                  path('job_apply/<int:pk>', JobApplyView.as_view(), name="job_apply"),  # bibin
