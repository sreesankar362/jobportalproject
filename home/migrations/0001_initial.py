    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_experience', models.PositiveIntegerField(blank=True, max_length=20, null=True)),
                ('max_experience', models.PositiveIntegerField(blank=True, max_length=20, null=True)),
